...
La funzione definisce il codice per decodificare la macchina di Mealy: prende via via ogni stato della macchina di Mealy prodotta nell'encoding e ritorna la stringa corrispondete a quello stato. %TODO spiegare meglio cosa fa questo
Poi viene definito il codice per fare l'encoding per la permutazine degli array: %TODO spiegare
