...
La funzione che abbiamo creato per Data Obfuscation è \texttt{encoding\_literal\_data()}. Questa funzione ha l'obiettivo di codificare il valore delle variabili, se di tipo intere o liste tramite la tecnica dell'\textit{Array Permutation}, se stringhe tramite la trasformazione verso una \textbf{Macchina di Mealy}.
